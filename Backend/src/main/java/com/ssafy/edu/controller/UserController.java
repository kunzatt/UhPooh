...
public class UserController {
    ...
    public ResponseEntity<Map<String, Object>> userList(@RequestParam int requestUserId) {
        ...
        try {
            ...
            return createResponse(false, "사용자 목록 조회 중 오류가 발생했습니다: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<Map<String, Object>> userDetail(@PathVariable int userId, @RequestParam int requestUserId) {
        ...
        try {
            ...
            return createResponse(false, "회원 정보 조회 중 오류가 발생했습니다: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<Map<String, Object>> userLogin(@RequestBody User user) {
        ...
        try {
            ...
            if (loginUser != null) {
                ...
                return createResponse(true, "로그인에 성공했습니다.", loginUser, HttpStatus.OK);
            } else {
                return createResponse(false, "이메일 또는 비밀번호가 일치하지 않습니다.", HttpStatus.UNAUTHORIZED);
            }
        } catch (Exception e) {
            logger.error("Error in userLogin: ", e);
            return createResponse(false, "로그인 중 오류가 발생했습니다: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<Map<String, Object>> userSignup(@RequestBody User user) {
        ...
        try {
            ...
            return createResponse(false, "회원가입 중 오류가 발생했습니다: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<Map<String, Object>> userUpdate(@PathVariable int userId, @RequestBody User user, @RequestParam int requestUserId) {
        ...
        try {
            ...
            return createResponse(false, "회원정보 수정 중 오류가 발생했습니다: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<Map<String, Object>> userIdCheck(@PathVariable String userEmail) {
        ...
        try {
            ...
            return createResponse(false, "이메일 중복 확인 중 오류가 발생했습니다: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<Map<String, Object>> userNameCheck(@PathVariable String userName) {
        ...
        try {
            ...
            return createResponse(false, "닉네임 중복 확인 중 오류가 발생했습니다: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<Map<String, Object>> updatePassword(@PathVariable int userId,
        ...
        try {
            ...
            if (!request.containsKey("currentPassword") || !request.containsKey("newPassword")
                ...
                return createResponse(false, "현재 비밀번호, 새로운 비밀번호, 비밀번호 확인이 모두 필요합니다.", HttpStatus.BAD_REQUEST);
            }
            ...
            return createResponse(false, "비밀번호 수정 중 오류가 발생했습니다: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<Map<String, Object>> userLogout(@PathVariable int userId) {
        ...
        try {
            ...
            return createResponse(false, "로그아웃 처리 중 오류가 발생했습니다: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<Map<String, Object>> userDelete(@PathVariable int userId, @RequestParam int requestUserId) {
        ...
        try {
            ...
            return createResponse(false, "회원 탈퇴 처리 중 오류가 발생했습니다: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<Map<String, Object>> searchByEmail(
        ...
        try {
            ...
            return createResponse(false, "회원 검색 중 오류가 발생했습니다: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
